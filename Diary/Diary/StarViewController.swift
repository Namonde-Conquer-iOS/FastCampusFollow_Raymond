...
class StarViewController: UIViewController {
    ...
    @objc func starDiaryNotification(_ notifiaction: Notification) {
        guard let starDiary = notifiaction.object as? [String: Any] else { return }
